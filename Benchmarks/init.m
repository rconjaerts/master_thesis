function init(mop,itrCounter)
%Set up the initial setting for the MOEA/D.
%loading the params.

    global subproblems params idealpoint parDim objDim window1 step1 fnum at bt ct dt et Fps Gps Hpf Mpf Gpf;
    ...
    for i=1:params.popsize
        ind = randompoint(mop);
        [value, ind] = evaluate( mop, ind ,itrCounter);
