...
public class Cell {
	...
	private Problem problem = new ZDT2();
	...
	public Cell(ArrayList<Double> points, ArrayList<double[]> pointDomains, int lastSplitDomain, int k){
		this.k=k;
	...
	public void splitCell(){
		...
		for(int i = 0; i<k;i++){
			...
			children.add(new Cell(newPoints, newPointDomains, lastSplitDomain, k));
		}
	}
	...
	public void setChildren(ArrayList<Cell> children) {
		this.children = children;
	}

	public void getOfficialResult() {
